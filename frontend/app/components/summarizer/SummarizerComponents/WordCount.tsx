// Types
import { WordCounts } from '../../../types/types';

// State management and context
import { useState, useEffect } from 'react';
import { useCorpusMetaData } from '@context/corpusMetadata/useCorpusMetadata';
import { useSummaryContext, useSummaryDispatch } from '@context/summaryMetadata/useSummaryMetadata';

// API
import { checkCorpusFilesExistInDB, checkCorpusPreppedStatus, fetchWordCountData, fetchWordListsData, aggregateWordCountsData, reAggregateWordCountsData } from '../../../api/summarizeCorpus';
...
const WordCount = () => {
    ...
    const handleSummarizeWords = async () => {
        ...
        // const wordCounts = await aggregateWordCountsData(corpusMetadata.corpus.id);
